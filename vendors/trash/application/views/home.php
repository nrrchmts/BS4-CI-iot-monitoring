      ...
      <div class="row">
        <div class="col-lg">
          <div class="card">
            ...
            <div class="card-body">
              <!-- DataTales Example -->
              <table id="" class="table table-responsive-sm table-striped table-hover text-center">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php foreach ($sektor as $sektor1) : ?>
                    <tr>
                      ...
                      <td><?= $sektor1['ds18b20']; ?></td>
                      <td>7</td>
                      <td><?= $sektor1['mq_135']; ?></td>
                      <td><?= $volume_air['volume'];  ?></td>
                      <?php
                      $volumeCalc = ($setValue['field_length'] * $setValue['field_width'] * ($setValue['field_height'] - $volume_air['volume'])) / 1000;
                      ?>
                      <td><?= $volumeCalc; ?></td>
